import{a as l,b as k}from"./vendor-7ba42fd8.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))e(a);new MutationObserver(a=>{for(const c of a)if(c.type==="childList")for(const n of c.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&e(n)}).observe(document,{childList:!0,subtree:!0});function s(a){const c={};return a.integrity&&(c.integrity=a.integrity),a.referrerpolicy&&(c.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?c.credentials="include":a.crossorigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function e(a){if(a.ep)return;a.ep=!0;const c=s(a);fetch(a.href,c)}})();const _={_baseURL:"https://food-boutique.b.goit.study/api",_categoriesURL:"/products/categories",_productsURL:"/products",_popularURL:"/products/popular",_discountURL:"/products/discount",_subscriptionURL:"/subscription",_orderURL:"/orders",categories:async function(){try{return(await l.get(this._baseURL+this._categoriesURL)).data}catch(t){throw t}},popular:async function(){try{return(await l.get(this._baseURL+this._popularURL)).data}catch(t){throw t}},discount:async function(){try{return(await l.get(this._baseURL+this._discountURL)).data}catch(t){throw t}},product:async function(t){try{return(await l.get(this._baseURL+this._productsURL+`/${t}`)).data}catch(s){throw s}},products:async function(t={}){try{const s={params:t};return(await l.get(this._baseURL+this._productsURL,s)).data}catch(s){throw s}},subscribe:async function(t){try{const s={email:t};return await l.post(this._baseURL+this._subscriptionURL,s)}catch(s){throw s}},order:async function(t){try{return(await l.post(this._baseURL+this._orderURL,t)).data}catch(s){throw s}}};class p{constructor(){const t=document.querySelectorAll(".js-object");for(let s=0;s<t.length;s++)"dataset"in t[s]&&"jsname"in t[s].dataset&&(this[t[s].dataset.jsname]=t[s])}refresh(){for(var t in this)t in this&&delete this[t];const s=document.querySelectorAll(".js-object");for(let e=0;e<s.length;e++)"dataset"in s[e]&&"jsname"in s[e].dataset&&(this[s[e].dataset.jsname]=s[e])}}function U(o,t){const s=k.create(o,{onShow:a=>{document.addEventListener("keydown",e),a.element().querySelector(t).onclick=a.close},onClose:()=>{document.removeEventListener("keydown",e)}});function e(a){a.key==="Escape"&&s.close()}s.show()}const R="/project-Bpfbt9js/assets/icons-03dfadd1.svg#close-icon",S="/project-Bpfbt9js/assets/icons-03dfadd1.svg#shopping-cart-icon";async function M(o,t){const e=o.target.closest(t).dataset.productid,{name:a,desc:c,img:n,category:h,price:r,size:f,popularity:j}=await _.product(e);let y="Add to",v=i.loadCart();"products"in v&&v.products.findIndex(m=>m.productId===e)!==-1&&(y="Remove from");const C=`<div class="container">
  <div class="modal-product">
      ...
      <div class="modal-product-bottom">
    ...
    </div>`;U(C,".js-modal-close"),document.querySelector(".js-modal-product-cart").addEventListener("click",w=>{const m=w.target.closest(".modal-product-cart");let d=i.loadCart(),I=!0;if("products"in d){const L=d.products.findIndex(E=>E.productId===e);L!==-1&&(d.products.splice(L,1),m.querySelector(".baskettext").innerHTML="Add to",I=!1)}I&&("products"in d?d.products.push({productId:e,amount:1}):d={email:"",products:[{productId:e,amount:1}]},m.querySelector(".baskettext").innerHTML="Remove from"),i.saveCart(d)})}const D="/project-Bpfbt9js/assets/icons-03dfadd1.svg#discount-icon",b="/project-Bpfbt9js/assets/icons-03dfadd1.svg#discount-cart",g="/project-Bpfbt9js/assets/icons-03dfadd1.svg#discount-checked";async function A(){const t=new p;t.discountList.innerHTML="";const s=await _.discount(),e=[];let a=0;for(s.length<2?a=s.length:a=2;a>0;a--){let r=Math.floor(Math.random()*s.length);e.push(s[r]),s.splice(r,1)}let c=i.loadCart();const n=[];"products"in c&&(c=c.products,c.forEach(r=>n.push(r.productId)));const h=[];e.forEach(r=>{let f=b;n.includes(r._id)&&(f=g),h.push(`
        <li class="discount-list-item discount-show" data-productId="${r._id}">
            <svg width="60" height="60" class="discount-icon discount-show"  data-productId="${r._id}">
              <use href="${D}" class="discount-show"  data-productId="${r._id}"></use>
            </svg>
              ...
              <div class="discount-description-price discount-show"  data-productId="${r._id}">
                ...
                <button type="button" class="discount-icon-box discount-buy" data-productId="${r._id}">
                  <svg width="18" height="18" class="discount-cart discount-buy" data-productId="${r._id}">
                    <use href="${f}" class="js-object discount-buy" data-jsname="discountIcon${r._id}" data-productId="${r._id}"></use>
                  </svg>
                </button>
              </div>
            </div>
...
//# sourceMappingURL=footer-modal-10b4b4e5.js.map
