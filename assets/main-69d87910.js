import{a as p,b as H}from"./vendor-0363fca5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerpolicy&&(n.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?n.credentials="include":e.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(e){if(e.ep)return;e.ep=!0;const n=s(e);fetch(e.href,n)}})();class l{constructor(){const t=document.querySelectorAll(".js-object");for(let s=0;s<t.length;s++)"dataset"in t[s]&&"jsname"in t[s].dataset&&(this[t[s].dataset.jsname]=t[s])}refresh(){for(var t in this)t in this&&delete this[t];const s=document.querySelectorAll(".js-object");for(let a=0;a<s.length;a++)"dataset"in s[a]&&"jsname"in s[a].dataset&&(this[s[a].dataset.jsname]=s[a])}}const L={_baseURL:"https://food-boutique.b.goit.study/api",_categoriesURL:"/products/categories",_productsURL:"/products",_popularURL:"/products/popular",_discountURL:"/products/discount",_subscriptionURL:"/subscription",_orderURL:"/orders",categories:async function(){try{return(await p.get(this._baseURL+this._categoriesURL)).data}catch(t){throw t}},popular:async function(){try{return(await p.get(this._baseURL+this._popularURL)).data}catch(t){throw t}},discount:async function(){try{return(await p.get(this._baseURL+this._discountURL)).data}catch(t){throw t}},product:async function(t){try{return(await p.get(this._baseURL+this._productsURL+`/${t}`)).data}catch(s){throw s}},products:async function(t={}){try{const s={params:t};return(await p.get(this._baseURL+this._productsURL,s)).data}catch(s){throw s}},subscribe:async function(t){try{const s={email:t};return(await p.post(this._baseURL+this._subscriptionURL,s)).data}catch(s){throw s}},order:async function(t){try{return(await p.post(this._baseURL+this._orderURL,t)).data}catch(s){throw s}}},i={_filterID:"filter-project-Bpfbt9js",_cartID:"cart-project-Bpfbt9js",_save:function(t,s){try{const a=JSON.stringify(s);localStorage.setItem(t,a)}catch(a){throw a}},_load:function(t){try{const s=localStorage.getItem(t);return s===null?{}:JSON.parse(s)}catch(s){throw s}},_delete:function(t){try{localStorage.removeItem(t)}catch(s){throw s}},saveFilter:function(t){this._save(this._filterID,t)},loadFilter:function(){return this._load(this._filterID)},deleteFilter:function(){this._delete(this._filterID)},saveCart:function(t){this._save(this._cartID,t),G("discountIcon"),P()},loadCart:function(){return this._load(this._cartID)},deleteCart:function(){this._delete(this._cartID)}};function F(o,t){const s=H.create(o,{onShow:e=>{document.addEventListener("keydown",a),e.element().querySelector(t).onclick=e.close},onClose:()=>{document.removeEventListener("keydown",a)}});function a(e){e.key==="Escape"&&s.close()}s.show()}const z="/project-Bpfbt9js/assets/icons-5dbc4c13.svg#close-icon",V="/project-Bpfbt9js/assets/icons-5dbc4c13.svg#shopping-cart-icon";async function M(o,t){const a=o.target.closest(t).dataset.productid,{name:e,desc:n,img:r,category:h,price:c,size:m,popularity:N}=await L.product(a);let j="Add to",k=i.loadCart();"products"in k&&k.products.findIndex(b=>b.productId===a)!==-1&&(j="Remove from");const O=`<div class="container">
  <div class="modal-product">
      ...
      <div class="modal-product-bottom">
    ...
    </div>`;F(O,".js-modal-close"),document.querySelector(".js-modal-product-cart").addEventListener("click",C=>{const b=C.target.closest(".modal-product-cart");let u=i.loadCart(),E=!0;if("products"in u){const S=u.products.findIndex(A=>A.productId===a);S!==-1&&(u.products.splice(S,1),b.querySelector(".baskettext").innerHTML="Add to",E=!1)}E&&("products"in u?u.products.push({productId:a,amount:1}):u={email:"",products:[{productId:a,amount:1}]},b.querySelector(".baskettext").innerHTML="Remove from"),i.saveCart(u)})}const J="/project-Bpfbt9js/assets/icons-5dbc4c13.svg#discount-icon",I="/project-Bpfbt9js/assets/icons-5dbc4c13.svg#discount-cart",$="/project-Bpfbt9js/assets/icons-5dbc4c13.svg#discount-checked";async function K(){const t=new l;t.discountList.innerHTML="";const s=await L.discount(),a=[];let e=0;for(s.length<2?e=s.length:e=2;e>0;e--){let c=Math.floor(Math.random()*s.length);a.push(s[c]),s.splice(c,1)}let n=i.loadCart();const r=[];"products"in n&&(n=n.products,n.forEach(c=>r.push(c.productId)));const h=[];a.forEach(c=>{let m=I;r.includes(c._id)&&(m=$),h.push(`
        ...
        `)}),t.discountList.insertAdjacentHTML("beforeend",h.join(""))}function U(o){let t=i.loadCart(),s=!1;return"products"in t&&t.products.forEach(a=>{if(a.productId===o){s=!0;return}}),s}function R(o){let t=i.loadCart();U(o)||("products"in t?t.products.push({productId:o,amount:1}):t={email:"",products:[{productId:o,amount:1}]},i.saveCart(t))}function W(o,t){const s=new l;s[`${t}${o}`].href.baseVal===`${I}`&&(s[`${t}${o}`].href.baseVal=`${$}`)}function Y(o,t){const s=new l;s[`${t}${o}`].href.baseVal===`${$}`&&(s[`${t}${o}`].href.baseVal=`${I}`)}function G(o){const t=new l;for(var s in t)if(s.indexOf(o)===0){let a=t[s].dataset.productid;U(a)?W(a,o):Y(a,o)}}function Q(o){o.target.classList.contains("discount-buy")?R(o.target.dataset.productid):o.target.classList.contains("discount-show")&&M(o,".discount-show")}function P(){const o=new l;let t=0,s=i.loadCart();"products"in s&&(t=s.products.length),console.log(t),o.headerCartNumber.textContent=t}let w,_,g,f;async function x(){w=new l,w.PopularList.innerHTML="",_=await L.popular(),st()}function X(o){g=o.target.closest(".cards-item").dataset.id,f[`btn1${g}`].style.display="none",f[`check${g}`].style.display="flex",R(g)}function Z(o){if(o.target.classList.contains("js-btn")){X(o);return}if(!o.target.classList.contains("js-btn")){M(o,".cards-item");return}}function tt(o){return o.map(({_id:t,img:s,name:a,category:e,size:n,popularity:r})=>` 
...
`).join("")}async function st(){try{const o=_;w.PopularList.insertAdjacentHTML("beforeend",tt(o)),f=new l;let t=i.loadCart();const s=[];"products"in t&&(t=t.products,t.forEach(e=>s.push(e.productId)));const a=[];return _.forEach(e=>{s.includes(e._id)&&(f[`btn1${e._id}`].style.display="none",f[`check${e._id}`].style.display="flex")}),await o}catch(o){console.log(o.message)}}const d={openModalBtn:document.querySelector('[data-action="open-modal"]'),closeModalBtn:document.querySelector('[data-action="close-modal"]'),backdrop:document.querySelector(".js-backdrop"),modalImg:document.querySelector(".modal__food-basket"),modalInner:document.querySelector(".modal-inner")},T=document.querySelector(".footer-form"),ot="Escape";function v(){window.addEventListener("keydown",D),d.closeModalBtn.addEventListener("click",y),d.backdrop.addEventListener("click",B),document.body.classList.add("show-modal")}function y(){window.removeEventListener("keydown",D),d.closeModalBtn.removeEventListener("click",y),d.backdrop.removeEventListener("click",B),document.body.classList.remove("show-modal")}function B(o){o.currentTarget===o.target&&y()}function D(o){o.code===ot&&y()}async function et(o){o.preventDefault();const t=o.target.elements.email.value;console.log(t);const s={email:t},a={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)};await fetch("https://food-boutique.b.goit.study/api/subscription",a).then(e=>{if(e.json(),console.log(e),e.status===409){v(),d.modalImg.style.display="none",d.modalInner.innerHTML=`
        ...
        </div>`;return}if(e.status===201){v(),d.modalImg.style.display="block",d.modalInner.innerHTML=`
        <div class="modal__title--wrap">
        <p class="modal__title">
      ...
      <div class="modal__description--wrap">
        <p class="modal__description">
          ...
          `,T.reset();return}v()}).catch(e=>console.log(e.message))}const q=new l;T.addEventListener("submit",et);x();K();P();q.discountList.addEventListener("click",Q);x();q.PopularList.addEventListener("click",Z);
//# sourceMappingURL=main-69d87910.js.map
