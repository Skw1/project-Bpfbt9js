import{a as m,b as tt}from"./vendor-7ba42fd8.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function e(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerpolicy&&(n.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?n.credentials="include":o.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(o){if(o.ep)return;o.ep=!0;const n=e(o);fetch(o.href,n)}})();class p{constructor(){const t=document.querySelectorAll(".js-object");for(let e=0;e<t.length;e++)"dataset"in t[e]&&"jsname"in t[e].dataset&&(this[t[e].dataset.jsname]=t[e])}refresh(){for(var t in this)t in this&&delete this[t];const e=document.querySelectorAll(".js-object");for(let a=0;a<e.length;a++)"dataset"in e[a]&&"jsname"in e[a].dataset&&(this[e[a].dataset.jsname]=e[a])}}const _={_baseURL:"https://food-boutique.b.goit.study/api",_categoriesURL:"/products/categories",_productsURL:"/products",_popularURL:"/products/popular",_discountURL:"/products/discount",_subscriptionURL:"/subscription",_orderURL:"/orders",categories:async function(){try{return(await m.get(this._baseURL+this._categoriesURL)).data}catch(t){throw t}},popular:async function(){try{return(await m.get(this._baseURL+this._popularURL)).data}catch(t){throw t}},discount:async function(){try{return(await m.get(this._baseURL+this._discountURL)).data}catch(t){throw t}},product:async function(t){try{return(await m.get(this._baseURL+this._productsURL+`/${t}`)).data}catch(e){throw e}},products:async function(t={}){try{const e={params:t};return(await m.get(this._baseURL+this._productsURL,e)).data}catch(e){throw e}},subscribe:async function(t){try{const e={email:t};return(await m.post(this._baseURL+this._subscriptionURL,e)).data}catch(e){throw e}},order:async function(t){try{return(await m.post(this._baseURL+this._orderURL,t)).data}catch(e){throw e}}},l={_filterID:"filter-project-Bpfbt9js",_cartID:"cart-project-Bpfbt9js",_save:function(t,e){try{const a=JSON.stringify(e);localStorage.setItem(t,a)}catch(a){throw a}},_load:function(t){try{const e=localStorage.getItem(t);return e===null?{}:JSON.parse(e)}catch(e){throw e}},_delete:function(t){try{localStorage.removeItem(t)}catch(e){throw e}},saveFilter:function(t){this._save(this._filterID,t)},loadFilter:function(){return this._load(this._filterID)},deleteFilter:function(){this._delete(this._filterID)},saveCart:function(t){this._save(this._cartID,t),rt("discountIcon"),B()},loadCart:function(){return this._load(this._cartID)},deleteCart:function(){this._delete(this._cartID)}};function st(s,t){const e=tt.create(s,{onShow:o=>{document.addEventListener("keydown",a),o.element().querySelector(t).onclick=o.close},onClose:()=>{document.removeEventListener("keydown",a)}});function a(o){o.key==="Escape"&&e.close()}e.show()}const et="/project-Bpfbt9js/assets/icons-03dfadd1.svg#close-icon",ot="/project-Bpfbt9js/assets/icons-03dfadd1.svg#shopping-cart-icon";async function x(s,t){const a=s.target.closest(t).dataset.productid,{name:o,desc:n,img:i,category:r,price:c,size:w,popularity:Q}=await _.product(a);let N="Add to",O=l.loadCart();"products"in O&&O.products.findIndex($=>$.productId===a)!==-1&&(N="Remove from");const X=`<div class="container">
  <div class="modal-product">
      ...
      <div class="modal-product-top">
        ...
        <div class="modal-dscr-wrapper">
          ...
          <div class="modal-product-prop-wrap">
            ...
            <p class="modal-product-prop">
              Size:
              <span class="modal-product-prop-span">${w}</span>
            </p>
            </div>
            <p class="modal-product-prop">
    ...
    </div>`;st(X,".js-modal-close"),document.querySelector(".js-modal-product-cart").addEventListener("click",R=>{const $=R.target.closest(".modal-product-cart");let f=l.loadCart(),P=!0;if("products"in f){const q=f.products.findIndex(Z=>Z.productId===a);q!==-1&&(f.products.splice(q,1),$.querySelector(".baskettext").innerHTML="Add to",P=!1)}P&&("products"in f?f.products.push({productId:a,amount:1}):f={email:"",products:[{productId:a,amount:1}]},$.querySelector(".baskettext").innerHTML="Remove from"),l.saveCart(f)})}const at="/project-Bpfbt9js/assets/icons-03dfadd1.svg#discount-icon",M="/project-Bpfbt9js/assets/icons-03dfadd1.svg#discount-cart",T="/project-Bpfbt9js/assets/icons-03dfadd1.svg#discount-checked";async function ct(){const t=new p;t.discountList.innerHTML="";const e=await _.discount(),a=[];let o=0;for(e.length<2?o=e.length:o=2;o>0;o--){let c=Math.floor(Math.random()*e.length);a.push(e[c]),e.splice(c,1)}let n=l.loadCart();const i=[];"products"in n&&(n=n.products,n.forEach(c=>i.push(c.productId)));const r=[];a.forEach(c=>{let w=M;i.includes(c._id)&&(w=T),r.push(`
...
`).join("")}async function ft(){try{const s=S;k.PopularList.insertAdjacentHTML("beforeend",pt(s)),b=new p;let t=l.loadCart();const e=[];"products"in t&&(t=t.products,t.forEach(o=>e.push(o.productId)));const a=[];return S.forEach(o=>{e.includes(o._id)&&(b[`btn1${o._id}`].style.display="none",b[`check${o._id}`].style.display="flex")}),await s}catch(s){console.log(s.message)}}const u={openModalBtn:document.querySelector('[data-action="open-modal"]'),closeModalBtn:document.querySelector('[data-action="close-modal"]'),backdrop:document.querySelector(".js-backdrop"),modalImg:document.querySelector(".modal__food-basket"),modalInner:document.querySelector(".modal-inner")},H=document.querySelector(".footer-form"),mt="Escape";function C(){window.addEventListener("keydown",J),u.closeModalBtn.addEventListener("click",I),u.backdrop.addEventListener("click",F),document.body.classList.add("show-modal")}function I(){window.removeEventListener("keydown",J),u.closeModalBtn.removeEventListener("click",I),u.backdrop.removeEventListener("click",F),document.body.classList.remove("show-modal")}function F(s){s.currentTarget===s.target&&I()}function J(s){s.code===mt&&I()}async function ht(s){s.preventDefault();const t=s.target.elements.email.value;console.log(t);const e={email:t},a={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)};await fetch("https://food-boutique.b.goit.study/api/subscription",a).then(o=>{if(o.json(),console.log(o),o.status===409){C(),u.modalImg.style.display="none",u.modalInner.innerHTML=`
      ...
      <div class="modal__description--wrap">
        <p class="modal__description">
          ...
          `,H.reset();return}C()}).catch(o=>console.log(o.message))}const y=document.querySelector(".product_card-list");function gt(s){const t=s.target.closest(".product_card-item").dataset.productid;if(s.target.classList.contains("product_card-item")||s.target!==s.currentTarget){if(s.target.nodeName==="use"||s.target.nodeName==="BUTTON"||s.target.nodeName==="svg"){console.log(t),U(t),D(t,"shoppingCartIcon");return}x(s,".product_card-item");return}}function E(s){const{category:t,img:e,name:a,popularity:o,price:n,size:i,_id:r,is10PercentOff:c}=s;return c?`
  ...
  `}async function bt(){(await _.products()).results.map(t=>y.insertAdjacentHTML("beforeend",E(t)))}function yt(s,t){if(y.innerHTML="",s)return s.map(e=>y.insertAdjacentHTML("beforeend",E(e)));if(t)return t.length===0&&window.alert("Oops something went wrong"),t.map(e=>y.insertAdjacentHTML("beforeend",E(e)))}const h=document.querySelector("#dropdownMenu"),z=document.querySelector("#input-filter"),vt=document.querySelector("#filterButt"),v=document.querySelector(".category-content"),_t=document.querySelector(".dropdown-toggle"),L="keyword",V="category";let g=JSON.parse(localStorage.getItem(L)),d=JSON.parse(localStorage.getItem(V));function K(){(g||d)&&(z.value=g,v.textContent=d)}async function Y(){const s=await _.categories();d!==null?v.textContent=d:v.textContent="Categories",h.innerHTML="",s.forEach(async t=>{const e=document.createElement("div");e.className="dropdown-item",e.textContent=t,e.onclick=async function(){d=t,localStorage.setItem(V,JSON.stringify(d)),W()},h.appendChild(e)})}async function W(){h.style.display=h.style.display==="flex"?"none":"flex",d!==null?v.textContent=d:v.textContent="Categories",setTimeout(function(){h.style.opacity=h.style.opacity==="1"?"0":"1"},10)}function wt(s){const t=s.target.value;t?localStorage.setItem(L,JSON.stringify(t)):localStorage.setItem(L,JSON.stringify(null))}async function $t(s){s.preventDefault(),g==""?g=null:g=JSON.parse(localStorage.getItem(L)),console.log(d,g)}K();Y();const G=new p;B();bt();y.addEventListener("click",gt);dt();G.PopularList.addEventListener("click",ut);ct();Y();K();yt();G.discountList.addEventListener("click",it);_t.addEventListener("click",W);z.addEventListener("input",wt);vt.addEventListener("click",$t);H.addEventListener("submit",ht);
//# sourceMappingURL=main-ddb341bd.js.map
